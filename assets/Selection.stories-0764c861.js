import{j as s}from"./jsx-runtime-9c4ae004.js";import{r as C}from"./index-1b03fe98.js";import{C as m,N as S,E as k,M as G,a as Q,I as T,L as V,P as W,R as X,A as Y}from"./Icon-046b6023.js";import{u as Z}from"./IntersectionQuery-1c2e7c35.js";import{b as $,r as D}from"./crudHelpers-031fd461.js";import"./index-6fd5a17b.js";import"./_commonjs-dynamic-modules-302442b1.js";const E=({selections:d=[],nodes:c=[],edges:i=[],hotkeys:r=["selectAll","deselect","delete"],disabled:l,onSelection:o,onDataChange:a})=>{const[g,u]=C.useState(d),[e,n]=C.useState(!1),v=t=>{if(!l&&!g.includes(t)){const y=[...g,t];o==null||o(y),u(y)}},w=t=>{if(!l&&g.includes(t)){const y=g.filter(F=>F!==t);o==null||o(y),u(y)}},j=t=>{g.includes(t)?w(t):v(t)},x=(t=[])=>{l||(u(t),o==null||o(t))},q=(t,p)=>{t.preventDefault(),t.stopPropagation(),e?j(p.id):x([p.id]),n(!1)},z=t=>{t.preventDefault(),n(t.metaKey||t.ctrlKey)},B=()=>{x(),n(!1)};return Z([{name:"Select All",keys:"mod+a",disabled:!r.includes("selectAll"),category:"Canvas",description:"Select all nodes and edges",callback:t=>{if(t.preventDefault(),!l){const p=c.map(y=>y.id);a==null||a(c,i),o==null||o(p),u(p)}}},{name:"Delete Selections",category:"Canvas",disabled:!r.includes("delete"),description:"Delete selected nodes and edges",keys:"backspace",callback:t=>{if(!l){t.preventDefault();const p=$(c,i,g);a==null||a(p.nodes,p.edges),o==null||o([]),u([])}}},{name:"Deselect Selections",category:"Canvas",disabled:!r.includes("deselect"),description:"Deselect selected nodes and edges",keys:"escape",callback:t=>{l||(t.preventDefault(),o==null||o([]),u([]))}}]),{onClick:q,onKeyDown:z,onCanvasClick:B,selections:g,clearSelections:x,addSelection:v,removeSelection:w,toggleSelection:j,setSelections:u}},ce={title:"Demos/Selections",component:m,subcomponents:{Node:S,Edge:k,MarkerArrow:G,Arrow:Q,Icon:T,Label:V,Port:W,Remove:X,Add:Y}},h=()=>{const[d,c]=C.useState([{id:"1",text:"Node 1"},{id:"2",text:"Node 2"}]),[i,r]=C.useState([{id:"1-2",from:"1",to:"2"}]),{selections:l,onCanvasClick:o,onClick:a,onKeyDown:g,clearSelections:u}=E({nodes:d,edges:i,onDataChange:(e,n)=>{console.info("Data changed",e,n),c(e),r(n)},onSelection:e=>{console.info("Selection",e)}});return s.jsxs("div",{style:{position:"absolute",top:0,bottom:0,left:0,right:0},children:[s.jsxs("pre",{style:{position:"absolute",bottom:15,right:15,background:"rgba(0, 0, 0, .5)",padding:20,color:"white"},children:[s.jsx("h3",{style:{padding:0,margin:0},children:"Selections"}),s.jsx("code",{children:JSON.stringify(l,null,2)})]}),s.jsx(m,{nodes:d,edges:i,selections:l,node:s.jsx(S,{onClick:(e,n)=>{console.log("Selecting Node",e,n),a(e,n)},onKeyDown:(e,n)=>{console.log("Keydown Event",n,e),g(e)},onRemove:(e,n)=>{const v=D(d,i,n);r(v.edges),c(v.nodes),u()}}),edge:s.jsx(k,{onClick:(e,n)=>{console.log("Selecting Edge",e,n),a(e,n)}}),onCanvasClick:e=>{console.log("Canvas Clicked",e),o()},onLayoutChange:e=>console.log("Layout",e)})]})},f=()=>{const[d,c]=C.useState([{id:"1",text:"Node 1"},{id:"3",text:"Node 2",parent:"1"},{id:"2",text:"Node 2"}]),[i,r]=C.useState([{id:"1-2",from:"1",to:"2"}]),{selections:l,onCanvasClick:o,onClick:a,onKeyDown:g,clearSelections:u}=E({nodes:d,edges:i,onDataChange:(e,n)=>{console.info("Data changed",e,n),c(e),r(n)},onSelection:e=>{console.info("Selection",e)}});return s.jsxs("div",{style:{position:"absolute",top:0,bottom:0,left:0,right:0},children:[s.jsxs("pre",{style:{position:"absolute",bottom:15,right:15,background:"rgba(0, 0, 0, .5)",padding:20,color:"white"},children:[s.jsx("h3",{style:{padding:0,margin:0},children:"Selections"}),s.jsx("code",{children:JSON.stringify(l,null,2)})]}),s.jsx(m,{nodes:d,edges:i,selections:l,node:s.jsx(S,{onClick:(e,n)=>{console.log("Selecting Node",e,n),a(e,n)},onKeyDown:(e,n)=>{console.log("Keydown Event",n,e),g(e)},onRemove:(e,n)=>{const v=D(d,i,n);r(v.edges),c(v.nodes),u()}}),edge:s.jsx(k,{onClick:(e,n)=>{console.log("Selecting Edge",e,n),a(e,n)}}),onCanvasClick:e=>{console.log("Canvas Clicked",e),o()},onLayoutChange:e=>console.log("Layout",e)})]})},N=()=>{const[d,c]=C.useState([{id:"1",text:"Node 1"},{id:"2",text:"Node 2"}]),[i,r]=C.useState([{id:"1-2",from:"1",to:"2"}]),{selections:l,onCanvasClick:o,onClick:a,onKeyDown:g,clearSelections:u}=E({nodes:d,edges:i,selections:["1"],onDataChange:(e,n)=>{console.info("Data changed",e,n),c(e),r(n)},onSelection:e=>{console.info("Selection",e)}});return s.jsxs("div",{style:{position:"absolute",top:0,bottom:0,left:0,right:0},children:[s.jsxs("pre",{style:{position:"absolute",bottom:15,right:15,background:"rgba(0, 0, 0, .5)",padding:20,color:"white"},children:[s.jsx("h3",{style:{padding:0,margin:0},children:"Selections"}),s.jsx("code",{children:JSON.stringify(l,null,2)})]}),s.jsx(m,{nodes:d,edges:i,selections:l,node:s.jsx(S,{onClick:(e,n)=>{console.log("Selecting Node",e,n),a(e,n)},onKeyDown:(e,n)=>{console.log("Keydown Event",n,e),g(e)},onRemove:(e,n)=>{const v=D(d,i,n);r(v.edges),c(v.nodes),u()}}),edge:s.jsx(k,{onClick:(e,n)=>{console.log("Selecting Edge",e,n),a(e,n)}}),onCanvasClick:e=>{console.log("Canvas Clicked",e),o()},onLayoutChange:e=>console.log("Layout",e)})]})},b=()=>{const[d,c]=C.useState([]),[i]=C.useState([{id:"1",text:"Node 1"},{id:"2",text:"Node 2"}]),[r]=C.useState([{id:"1-2",from:"1",to:"2"}]);return s.jsxs("div",{style:{position:"absolute",top:0,bottom:0,left:0,right:0},children:[s.jsxs("pre",{style:{position:"absolute",bottom:15,right:15,background:"rgba(0, 0, 0, .5)",padding:20,color:"white"},children:[s.jsx("h3",{style:{padding:0,margin:0},children:"Selections"}),s.jsx("code",{children:JSON.stringify(d,null,2)})]}),s.jsx(m,{nodes:i,edges:r,selections:d,node:s.jsx(S,{onClick:(l,o)=>{console.log("Selecting Node",l,o),c([...d,o.id])}}),edge:s.jsx(k,{onClick:(l,o)=>{console.log("Selecting Edge",l,o),c([...d,o.id])}}),onCanvasClick:l=>{console.log("Canvas Clicked",l),c([])},onLayoutChange:l=>console.log("Layout",l)})]})};var K,L,A;h.parameters={...h.parameters,docs:{...(K=h.parameters)==null?void 0:K.docs,source:{originalSource:`() => {
...
}`,...(H=(_=b.parameters)==null?void 0:_.docs)==null?void 0:H.source}}};const ie=["Simple","Nested","Defaults","ManualSelection"];export{N as Defaults,b as ManualSelection,f as Nested,h as Simple,ie as __namedExportsOrder,ce as default};

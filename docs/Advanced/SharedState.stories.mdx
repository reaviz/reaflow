...
<Meta title="Docs/Advanced/Shared state" />
...
- [Vadorequest/poc-nextjs-reaflow](https://github.com/Vadorequest/poc-nextjs-reaflow) uses **Recoil** as shared State Manager.
